...
<table>
    <thead>
        <tr>
            <th rowspan="2"></th>
            <th colspan="3">PAD+</th>
            <th rowspan="2">Greenlight</th>
        </tr>
        <tr>
            <th>Activité séquence</th>
            <th>Bloc visioconférence</th>
            <th>Appel direct</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <th>Création (pour les professionnels uniquement)</th>
            <td>ajout et configuration par le professionnel</td>
            <td>tableau de bord</td>
            <td>page profil d'un autre usager</td>
            <td>autre interface web, comptes indépendants de la PAD+</td>
        </tr>
        <tr>
            <th>Accès des participants</th>
        ...
        <tr>
            <th>Participants extérieurs à la PAD+</th>
            <td>non</td>
            <td>non</td>
            <td>non</td>
            <td>oui (par lien d'invitation)</td>
        </tr>
    </tbody>
</table>
